...
var enrichDriver = function enrichDriver(connector, blockchains) {
  var _connector$triggers, _connector$actions;

  return _extends({}, connector, {
    triggers: ((_connector$triggers = connector.triggers) == null ? void 0 : _connector$triggers.map(function (trigger) {
      var _trigger$operation, _trigger$operation2, _trigger$operation3, _trigger$operation4, _trigger$operation5;

      return _extends({}, trigger, {
        operation: _extends({}, trigger.operation, {
          inputFields: [].concat(((_trigger$operation = trigger.operation) == null ? void 0 : _trigger$operation.type) === 'blockchain:event' && (((_trigger$operation2 = trigger.operation) == null ? void 0 : _trigger$operation2.inputFields) || []).filter(function (field) {
            return field.key === '_grinderyChain';
          }).length < 1 || connector.key === 'evmWallet' ? [{
            key: '_grinderyChain',
            type: 'string',
            label: 'Blockchain',
            placeholder: 'Select a blockchain',
            required: true,
            choices: blockchains.map(function (chain) {
              return {
                value: chain.value,
                label: chain.label,
                sample: chain.value,
          ...
          }] : [], ((_trigger$operation3 = trigger.operation) == null ? void 0 : _trigger$operation3.type) === 'blockchain:event' && (((_trigger$operation4 = trigger.operation) == null ? void 0 : _trigger$operation4.inputFields) || []).filter(function (field) {
            return field.key === '_grinderyContractAddress';
          }).length < 1 ? [{
            ...
            required: true
          }] : [], (((_trigger$operation5 = trigger.operation) == null ? void 0 : _trigger$operation5.inputFields) || []).filter(function (field) {
            return connector.key === 'evmWallet' && field.key !== '_grinderyChain' || connector.key !== 'evmWallet';
          }))
        })
      });
    })) || [],
    actions: ((_connector$actions = connector.actions) == null ? void 0 : _connector$actions.map(function (action) {
      var _action$operation, _action$operation2, _action$operation3, _action$operation4, _action$operation5;

      return _extends({}, action, {
        operation: _extends({}, action.operation, {
          inputFields: [].concat(((_action$operation = action.operation) == null ? void 0 : _action$operation.type) === 'blockchain:call' && (((_action$operation2 = action.operation) == null ? void 0 : _action$operation2.inputFields) || []).filter(function (field) {
            return field.key === '_grinderyChain';
          }).length < 1 || connector.key === 'evmWallet' ? [{
            key: '_grinderyChain',
            type: 'string',
          ...
          }] : [], ((_action$operation3 = action.operation) == null ? void 0 : _action$operation3.type) === 'blockchain:call' && (((_action$operation4 = action.operation) == null ? void 0 : _action$operation4.inputFields) || []).filter(function (field) {
            return field.key === '_grinderyContractAddress';
          }).length < 1 ? [{
            key: '_grinderyContractAddress',
            type: 'string',
            ...
            placeholder: 'Enter contract address',
            required: true
          }] : [], (((_action$operation5 = action.operation) == null ? void 0 : _action$operation5.inputFields) || []).filter(function (field) {
            return connector.key === 'evmWallet' && field.key !== '_grinderyChain' || connector.key !== 'evmWallet';
          }))
        })
      });
...
var processDriver = function processDriver(connector) {
  return _extends({}, connector, {
    triggers: connector.triggers && connector.triggers.length > 0 ? [].concat(connector.triggers.filter(function (trigger) {
      var _trigger$display;

      return !((_trigger$display = trigger.display) != null && _trigger$display.hidden);
    })) : undefined,
    actions: connector.actions && connector.actions.length > 0 ? [].concat(connector.actions.filter(function (action) {
      var _action$display;

      return !((_action$display = action.display) != null && _action$display.hidden);
    })) : undefined
  });
};
...
var CHAINS_PATH = 'https://cds.grindery.org/chains';
var CHAINS_STAGING_PATH = 'https://cds-staging.grindery.org/chains';
...
var NexusClient = /*#__PURE__*/function () {
  ...
  /*#__PURE__*/
  function () {
    var _isAllowedUser = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(app) {
      return _regeneratorRuntime().wrap(function _callee6$(_context6) {
        while (1) {
          switch (_context6.prev = _context6.next) {
            ...
            case 2:
              _context6.next = 4;
              return sendEngineRequest('or_isAllowedUser', {
                app: app || undefined
              }, this.token);
  ...
  function () {
    ...
    function testAction(_x12, _x13, _x14) {
  ...
  /*#__PURE__*/
  function () {
    var _requestEarlyAccess = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10(email, source, app) {
    ...
    function requestEarlyAccess(_x16, _x17, _x18) {
  ...
  function () {
    ...
    function saveWalletAddress(_x19, _x20) {
  ...
  function () {
    ...
    function callInputProvider(_x21, _x22, _x23, _x24) {
  ...
  function () {
    ...
    function callWebhook(_x25, _x26, _x27, _x28) {
  ...
  function () {
    var _listDrivers = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee14(environment) {
      ...
      var driversIndexURL, res, drivers;
        ...
        while (1) {
          switch (_context14.prev = _context14.next) {
            ...
            case 4:
              ...
              drivers = Object.keys(res.data).map(function (key) {
                return processDriver(_extends({}, res.data[key]));
              }).filter(function (driver) {
                var _driver$access, _driver$access2, _driver$user, _driver$access3, _driver$workspace;

                return driver && (!driver.access || ((_driver$access = driver.access) == null ? void 0 : _driver$access.toLowerCase()) === 'public' || _this.userId && ((_driver$access2 = driver.access) == null ? void 0 : _driver$access2.toLowerCase()) === 'private' && ((_driver$user = driver.user) == null ? void 0 : _driver$user.toLowerCase()) === _this.userId.toLowerCase() || _this.workspaceId && ((_driver$access3 = driver.access) == null ? void 0 : _driver$access3.toLowerCase()) === 'workspace' && ((_driver$workspace = driver.workspace) == null ? void 0 : _driver$workspace.toLowerCase()) === _this.workspaceId.toLowerCase());
              });
              return _context14.abrupt("return", drivers);
  ...
  /*#__PURE__*/
  function () {
    var _getDriver = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee15(driverKey, environment, enrich) {
      var driverURL, res, blockchains;
        ...
        while (1) {
          switch (_context15.prev = _context15.next) {
            ...
            case 7:
              ...
              _context15.next = 12;
              return this.listChains('evm', environment || 'production');

            case 12:
              blockchains = _context15.sent;
              return _context15.abrupt("return", enrichDriver(processDriver(res.data), blockchains || []));

            case 16:
              return _context15.abrupt("return", processDriver(res.data));
    ...
    function getDriver(_x30, _x31, _x32) {
  ...
  function () {
    ...
    function moveWorkflowToWorkspace(_x37, _x38) {
  ...
  function () {
    ...
    function addUserToWorkspace(_x39, _x40) {
  ...
  function () {
    ...
    function removeUserFromWorkspace(_x41, _x42) {
  ...
  function () {
    ...
    function addAdminToWorkspace(_x43, _x44) {
  ...
  function () {
    ...
    function removeAdminFromWorkspace(_x45, _x46) {
  ...
  function () {
    ...
    function listAuthCredentials(_x47, _x48) {
  ...
  function () {
    ...
    function updateAuthCredentials(_x49, _x50) {
  ...
  function () {
    ...
    function putConnectorSecrets(_x51, _x52, _x53) {
  ...
  _proto.saveNotificationsState =
  /*#__PURE__*/
  function () {
    var _saveNotificationsState = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee29(state, notificationToken) {
      var payload;
        ...
        while (1) {
          switch (_context29.prev = _context29.next) {
            ...
            case 4:
              ...
              _context29.next = 8;
              return sendEngineRequest('or_saveNotificationsState', payload, this.token);
    ...
    function saveNotificationsState(_x54, _x55) {
      return _saveNotificationsState.apply(this, arguments);
    }

    return saveNotificationsState;
  }()
  /**
  ...
  /*#__PURE__*/
  function () {
    var _runAction = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee30(step, input, environment) {
      return _regeneratorRuntime().wrap(function _callee30$(_context30) {
        while (1) {
          switch (_context30.prev = _context30.next) {
            ...
            case 6:
              _context30.next = 8;
              return sendEngineRequest('or_runAction', {
                step: step,
                input: input,
                environment: environment || 'production'
              }, this.token);
    ...
    function runAction(_x56, _x57, _x58) {
  ...
  /*#__PURE__*/
  function () {
    var _listChains = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee31(type, environment) {
      var base, url, res;
      return _regeneratorRuntime().wrap(function _callee31$(_context31) {
        while (1) {
          switch (_context31.prev = _context31.next) {
            ...
            case 9:
              res = _context31.sent;
              return _context31.abrupt("return", res && res.data || []);
    ...
    function listChains(_x59, _x60) {
      return _listChains.apply(this, arguments);
    }
  ...
  _proto.getUser = function getUser() {
    ...
    var id = this.userId;
    var address = id.split(':')[2];
    var address_short = address.substring(0, 6) + "..." + address.substring(address.length - 4);
    return {
      id: id,
      address: address,
  ...
  _proto.isUserHasEmail =
  /*#__PURE__*/
  function () {
    var _isUserHasEmail = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee32() {
      return _regeneratorRuntime().wrap(function _callee32$(_context32) {
        while (1) {
          switch (_context32.prev = _context32.next) {
            ...
            case 2:
              _context32.next = 4;
              return sendEngineRequest('or_isUserHasEmail', {}, this.token);
    ...
    function isUserHasEmail() {
      return _isUserHasEmail.apply(this, arguments);
    }

    return isUserHasEmail;
  }()
  /**
  ...
  _proto.updateUserEmail =
  /*#__PURE__*/
  function () {
    var _updateUserEmail = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee33(email) {
      return _regeneratorRuntime().wrap(function _callee33$(_context33) {
        while (1) {
          switch (_context33.prev = _context33.next) {
            ...
            case 4:
              _context33.next = 6;
              return sendEngineRequest('or_updateUserEmail', {
                email: email
              }, this.token);
  ...
  /*#__PURE__*/
  function () {
    var _deleteUser = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee34() {
      return _regeneratorRuntime().wrap(function _callee34$(_context34) {
        while (1) {
          switch (_context34.prev = _context34.next) {
            ...
            case 2:
              _context34.next = 4;
              return sendEngineRequest('or_deleteUser', {}, this.token);
  ...
  /*#__PURE__*/
  function () {
    var _getUserEmail = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee35() {
      return _regeneratorRuntime().wrap(function _callee35$(_context35) {
        while (1) {
          switch (_context35.prev = _context35.next) {
            ...
            case 2:
              _context35.next = 4;
              return sendEngineRequest('or_getUserEmail', {}, this.token);
