...
declare class NexusClient {
     ...
     */
    isAllowedUser(app?: 'flow' | 'gateway' | 'cds' | 'ping'): Promise<any>;
    /**
     ...
     */
    requestEarlyAccess(email: string, source?: string, app?: string): Promise<any>;
    /**
     ...
     */
    getDriver(driverKey: string, environment?: string, enrich?: boolean): Promise<any>;
    /**
     ...
     * @returns {Promise} Promise object with `true` on success
     */
    saveNotificationsState(state: string, notificationToken?: string): Promise<any>;
    /**
     ...
     * @returns {Promise} Promise object with action execution payload
     */
    runAction(step: Operation, input: unknown, environment?: string): Promise<any>;
    /**
     ...
     */
    listChains(type?: 'all' | 'evm' | 'non-evm', environment?: string): Promise<any>;
    /**
